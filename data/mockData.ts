...
export const mockLiveEvents: LiveEvent[] = [
  ...
  },
  {
    ...
    thumbnail: 'https://images.pexels.com/photos/1996339/pexels-photo-1996339.jpeg',
...
export const mockEvents: Event[] = [
  {
    ...
    image: 'https://images.pexels.com/photos/1996340/pexels-photo-1996340.jpeg',
    category: 'Festival',
    price: 45,
    capacity: 500,
    registered: 234,
...
export const mockCourses: Course[] = [
  {
    ...
    thumbnail: 'https://images.pexels.com/photos/1996342/pexels-photo-1996342.jpeg',
    instructor: {
      name: 'Emma Thompson',
  ...
  },
  {
    ...
    thumbnail: 'https://images.pexels.com/photos/1996343/pexels-photo-1996343.jpeg',
    instructor: {
      name: 'Hans Mueller',
...
export const mockMarketplaceItems: MarketplaceItem[] = [
  {
    ...
    price: 2500,
    images: ['https://images.pexels.com/photos/1996344/pexels-photo-1996344.jpeg'],
    category: 'Saddles',
    condition: 'excellent',
